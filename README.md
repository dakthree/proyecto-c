...
### Clips del evento
`/api/clips` filtra temporalmente los clips de Twitch a los participantes del evento y `CLIP_START_DATE` (por defecto 11/08/2026 12:00 en España peninsular para la prueba). En esta versión de prueba se acepta cualquier juego. YouTube Data API no expone la función Clips como recurso consultable; se usan vídeos publicados desde esa fecha en los canales participantes, sin filtro de juego.
