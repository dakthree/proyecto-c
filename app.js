...
{id:'anselhoenheim',name:'AnselHoenheim',image:'/assets/players/anselhoenheim.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Ladrón',positiveTraits:'Discreto, Sigiloso',negativeTraits:'Pacifista, Piel fina',twitch:'https://www.twitch.tv/anselhoenheim',youtube:'https://www.youtube.com/@AnselHoenheim',bio:'Perfil pendiente de información del personaje.'},
...
{id:'asssucar',name:'Asssucar',image:'/assets/players/asssucar.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Granjero',positiveTraits:'Fuerte, Jugador de beisbol',negativeTraits:'Analfabeto, Visible',twitch:'https://www.twitch.tv/asssucar',youtube:'https://www.youtube.com/@asssucar',bio:'Perfil pendiente de información del personaje.'},
...
{id:'feto',name:'Feto',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Obrero',positiveTraits:'Albañil, Peleón',negativeTraits:'Aprendiz lento, Duro de oído',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'fetodevaca',name:'Fetodevaca',image:'/assets/players/fetodevaca.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'PENDIENTE',positiveTraits:'PENDIENTE',negativeTraits:'PENDIENTE',twitch:'https://www.twitch.tv/fetodevaca',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'lagatarata',name:'LaGataRata',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Médico',positiveTraits:'Cazador, Poca sed',negativeTraits:'Dormilón, Sueño inquieto',twitch:'https://www.twitch.tv/xkattty',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'magikos',name:'Magikos',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Herrero',positiveTraits:'Artesano, Inventivo',negativeTraits:'Duro de oído, Miope',twitch:'https://www.twitch.tv/m4gikos',youtube:'https://www.youtube.com/@M4gikos',bio:'Perfil pendiente de información del personaje.'},
{id:'meremiau',name:'meremiau',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Reparador',positiveTraits:'Mañoso, Mecánico aficionado',negativeTraits:'Asmático, Fumador',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'miniyo2',name:'Miniyo2',image:'/assets/players/miniyo2.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Carpintero',positiveTraits:'Artesano, Herreria',negativeTraits:'Duro de oído, Piel fina',twitch:'https://www.twitch.tv/miniyo2',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'romgarrr',name:'romgarrr',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Desempleado',positiveTraits:'Cazador, Viejo explorador',negativeTraits:'Claustrofóbico, cobarde',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'solcius',name:'Solcius',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'PENDIENTE',positiveTraits:'PENDIENTE',negativeTraits:'PENDIENTE',twitch:'https://www.twitch.tv/Solcius',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'storvi',name:'Storvi',image:'/assets/players/storvi.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Bombero',positiveTraits:'Gimnasta, Hábil',negativeTraits:'Sanador lento, Visible',twitch:'https://www.twitch.tv/storviii',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'tencachi',name:'Tencachi',image:'/assets/players/tencachi.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Leñador',positiveTraits:'Peleón, Meticuloso',negativeTraits:'Sueño inquieto, Duro de oído',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'z3ttii',name:'Z3TTII',image:'/assets/players/z3ttii.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Agente de policía',positiveTraits:'Jardinero, Estomago de hierro',negativeTraits:'Comilón, Metabolismo lento',twitch:'https://www.twitch.tv/z3ttii',youtube:'https://www.youtube.com/@Z3TTII',bio:'Perfil pendiente de información del personaje.'},
...
{id:'zigurath',name:'zigurath',image:'/assets/players/zigurath.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Mecánico',positiveTraits:'Demonio de la velocidad, Valiente',negativeTraits:'Mucha sed, Dormilón',twitch:'https://www.twitch.tv/zigurath',youtube:'https://www.youtube.com/channel/UC36C8AulCMw5QAUV5wrfQpg',bio:'Perfil pendiente de información del personaje.'},
{id:'zonenzonao',name:'Zonenzonao',image:'/assets/players/zonenzonao.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Ladrón',positiveTraits:'Jugador de beisbol, Gimnasta',negativeTraits:'Sueño inquieto, Piel fina',twitch:'https://www.twitch.tv/zonenzonao',youtube:null,bio:'Perfil pendiente de información del personaje.'},
...
{id:'winwerin',name:'winwerin',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',profession:'Desempleado',positiveTraits:'Valiente, Vista águila',negativeTraits:'Sin rasgos negativos',twitch:'https://www.twitch.tv/winwerin',youtube:null,bio:'Perfil pendiente de información del personaje.'}
];
...
playerGrid.innerHTML=players.map(p=>`<article class="player-card" data-player="${p.id}" role="button" tabindex="0"><div class="player-photo"><img src="${p.image||'/assets/silueta.png'}" alt="Imagen de ${String(p.name).replace(/"/g,'&quot;')}" loading="lazy" onerror="this.onerror=null;this.src='/assets/silueta.png';"><span class="player-status registered">REGISTRADO</span></div><div class="player-info"><small>${p.twitch?'TWITCH':p.youtube?'YOUTUBE':'SIN CANAL'}</small><h3>${p.name}</h3><p class="player-profession"><b>PROFESIÓN:</b> ${p.profession||'PENDIENTE'}</p><div class="player-tags"><span class="tag">PARTICIPANTE</span>${p.twitch?'<span class="tag social twitch">TWITCH</span>':''}${p.youtube?'<span class="tag social youtube">YOUTUBE</span>':''}</div><div class="player-traits"><div class="player-trait positive"><b>+</b><span>${p.positiveTraits||'PENDIENTE'}</span></div><div class="player-trait negative"><b>−</b><span>${p.negativeTraits||'PENDIENTE'}</span></div></div></div></article>`).join('');
function openPlayer(id){const p=players.find(x=>x.id===id);if(!p)return;const links=[p.twitch?`<a class="modal-link twitch" href="${p.twitch}" target="_blank" rel="noopener noreferrer">TWITCH</a>`:'',p.youtube?`<a class="modal-link youtube" href="${p.youtube}" target="_blank" rel="noopener noreferrer">YOUTUBE</a>`:''].join('');document.getElementById('modalContent').innerHTML=`<div class="modal-sub">ARCHIVO DEL PARTICIPANTE</div><div class="modal-player-photo"><img src="${p.image||'/assets/silueta.png'}" alt="Imagen de ${String(p.name).replace(/"/g,'&quot;')}"></div><h3>${p.name}</h3><div class="modal-sub">PARTICIPANTE</div><div class="modal-profile-facts"><div><small>PROFESIÓN</small><strong>${p.profession||'PENDIENTE'}</strong></div><div><small>RASGOS POSITIVOS</small><strong class="trait-positive-text">${p.positiveTraits||'PENDIENTE'}</strong></div><div><small>RASGOS NEGATIVOS</small><strong class="trait-negative-text">${p.negativeTraits||'PENDIENTE'}</strong></div></div><div class="modal-facts"><div class="modal-fact"><small>ESTADO</small><strong>REGISTRADO</strong></div><div class="modal-fact"><small>CANALES</small><strong>${p.twitch||p.youtube?'DISPONIBLES':'NO REGISTRADOS'}</strong></div><div class="modal-fact"><small>RELACIONES</small><strong>████████</strong></div></div>${links?`<div class="modal-links">${links}</div>`:''}`;document.getElementById('playerModal').classList.add('open');document.getElementById('playerModal').setAttribute('aria-hidden','false')}
