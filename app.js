...
const players = [
  ...
  {id:'andreshouse',name:'Andreshouse',image:'/assets/players/andreshouse.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'anselhoenheim',name:'AnselHoenheim',image:'/assets/players/anselhoenheim.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/anselhoenheim',youtube:'https://www.youtube.com/@AnselHoenheim',bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'asssucar',name:'Asssucar',image:'/assets/players/asssucar.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/asssucar',youtube:'https://www.youtube.com/@asssucar',bio:'Perfil pendiente de información del personaje.'},
  {id:'basquewanderer',name:'BasqueWanderer',image:'/assets/players/basquewanderer.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'brunusop',name:'BrunusOP',image:'/assets/players/brunusop.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/brunusop',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'cere',name:'Cere',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/cere',youtube:'https://www.youtube.com/channel/UCE1ISk9jQb7ykFQXy56NbaA',bio:'Perfil pendiente de información del personaje.'},
  {id:'elpelas97',name:'elpelas97',image:'/assets/players/elpelas97.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'elponja92',name:'ElPonja92',image:'/assets/players/elponja92.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/elponja92',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'emiliano-roca',name:'Emiliano Roca',image:'/assets/players/emiliano-roca.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/emilianorocaa',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'evarath',name:'evarath',image:'/assets/players/evarath.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/evarathz',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'ferrox',name:'Ferrox',image:'/assets/players/ferrox.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'fetodevaca',name:'Fetodevaca',image:'/assets/players/fetodevaca.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/fetodevaca',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'k4la',name:'K4la',image:'/assets/players/k4la.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:'https://www.youtube.com/@k4la_',bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'liss',name:'Liss',image:'/assets/players/liss.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'lordzacas',name:'lordzacas',image:'/assets/players/lordzacas.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/lordzacas',youtube:'https://www.youtube.com/@lordzacas3015',bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'miniyo2',name:'Miniyo2',image:'/assets/players/miniyo2.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/miniyo2',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'nemma',name:'Nemma',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/nemmacanon',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'rastafrikki',name:'RastaFrikki',image:'/assets/players/rastafrikki.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/rastafrikki',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'rubaso',name:'Rubaso',image:'/assets/players/rubaso.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'sarah',name:'Sarah',image:'/assets/players/sarah.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/sarahgk92',youtube:'https://www.youtube.com/sarahgk92',bio:'Perfil pendiente de información del personaje.'},
  {id:'shikafu6',name:'Shikafu6',image:'/assets/players/shikafu6.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/shikafu6',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'tencachi',name:'Tencachi',image:'/assets/players/tencachi.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:null,youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'titohc',name:'Titohc',image:'/assets/players/titohc.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/titohc',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'toni18',name:'Toni18',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/tonism18',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'tyzenh',name:'TyzenH',image:'/assets/players/tyzenh.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/tyzenh',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'xl-k-vic',name:'xL𝑜K𝑜Vic',image:'/assets/players/xlokovic.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/xlokovic',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  ...
  {id:'z3ttii',name:'Z3TTII',image:'/assets/players/z3ttii.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/z3ttii',youtube:'https://www.youtube.com/@Z3TTII',bio:'Perfil pendiente de información del personaje.'},
  {id:'zelune',name:'Zelune',image:'/assets/players/zelune.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/Zelune86',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'zigurath',name:'zigurath',image:'/assets/players/zigurath.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/zigurath',youtube:'https://www.youtube.com/channel/UC36C8AulCMw5QAUV5wrfQpg',bio:'Perfil pendiente de información del personaje.'},
  {id:'zonenzonao',name:'Zonenzonao',image:'/assets/players/zonenzonao.webp',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/zonenzonao',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'zripht',name:'Zripht',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/Zripht',youtube:null,bio:'Perfil pendiente de información del personaje.'},
  {id:'winwerin',name:'winwerin',character:'POR ASIGNAR',role:'PARTICIPANTE',status:'registered',twitch:'https://www.twitch.tv/winwerin',youtube:null,bio:'Perfil pendiente de información del personaje.'}
