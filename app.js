...
const trainingPositive = [
  ...
  {name:'Sigiloso',cost:10},
  {name:'Socorrista',cost:10},
  {name:'Demonio de la velocidad',cost:15},
  {name:'Albañil',cost:15},
  {name:'Organizado',cost:15},
  {name:'Artesano',cost:20},
  {name:'Inventivo',cost:20},
  {name:'Jardinero',cost:20},
  {name:'Estómago de hierro',cost:20},
  {name:'Corredor',cost:20},
  {name:'Nutricionista',cost:20},
  {name:'Meticuloso',cost:20},
  {name:'Amante de la naturaleza',cost:25},
  {name:'Cocinar',cost:25},
  {name:'Sanador rápido',cost:25},
  {name:'Tallador',cost:30},
  {name:'Adicto a la adrenalina',cost:30},
  {name:'Jugador de béisbol',cost:30},
  {name:'Piel dura',cost:30},
  {name:'Comedor ligero',cost:35},
  {name:'Hábil',cost:35},
  {name:'Poca sed',cost:35},
  {name:'Mañoso',cost:35},
  {name:'Oído fino',cost:35},
  {name:'Insomne',cost:40},
  {name:'Mecánico aficionado',cost:40},
  {name:'Herborista',cost:40},
  {name:'Pescador',cost:40},
  {name:'Vista de águila',cost:40},
  {name:'Gimnasta',cost:40},
  {name:'Manitas',cost:40},
  {name:'Resiliente',cost:50},
  {name:'Valiente',cost:50},
  {name:'Excursionista',cost:50},
  {name:'Peleón',cost:50},
  {name:'Viejo explorador',cost:50},
  {name:'Discreto',cost:50},
  {name:'Conocimiento de la Naturaleza',cost:50},
  {name:'Tirador de precisión',cost:60},
  {name:'Aprendiz rápido',cost:60},
  {name:'En forma',cost:60},
  {name:'Robusto',cost:60},
  {name:'Cazador',cost:70},
  {name:'Atlético',cost:80},
  {name:'Fuerte',cost:80},
  {name:'Ojos de gato',cost:1000000000}
];
const trainingSpecial = [
  {name:'Insensible',cost:100},
  {name:'Señor de las hachas',cost:100},
  {name:'Ladrón',cost:100},
  {name:'Herrería',cost:100},
  {name:'Cocinero',cost:100},
  {name:'Mecánico',cost:100},
  {name:'Noctámbulo',cost:100}
];
const trainingNegative = [
  {name:'Lector lento',cost:0},
  {name:'Analfabeto',cost:0},
  {name:'Sordo',cost:0},
  {name:'Dominguero',cost:5},
  {name:'Cobarde',cost:5},
  {name:'Metabolismo rápido',cost:5},
  {name:'Metabolismo lento',cost:5},
  {name:'Torpe',cost:5},
  {name:'Estómago delicado',cost:5},
  {name:'Sanador lento',cost:5},
  {name:'Pacifista',cost:5},
  {name:'Propenso a enfermar',cost:5},
  {name:'Visible',cost:5},
  {name:'Hemofobia',cost:5},
  {name:'Piel fina',cost:5},
  {name:'Mucha sed',cost:10},
  {name:'Dedos gordos',cost:10},
  {name:'Fumador',cost:10},
  {name:'Agorafóbico',cost:10},
  {name:'Claustrofóbico',cost:10},
  {name:'Comilón',cost:15},
  {name:'Sueño inquieto',cost:15},
  {name:'Débil',cost:15},
  {name:'En mala forma',cost:15},
  {name:'Miope',cost:20},
  {name:'Dormilón',cost:20},
  {name:'Duro de oído',cost:20},
  {name:'Enclenque',cost:20},
  {name:'Fuera de forma',cost:20},
  {name:'Obeso',cost:20},
  {name:'Bajo peso',cost:20},
  {name:'Asmático',cost:25},
  {name:'Sobrepeso',cost:25},
  {name:'Raquítico',cost:25},
  {name:'Aprendiz lento',cost:30},
...
(function initTraining(){
  ...
  function renderTierGrid(type){
    ...
    tierGrid.innerHTML=tiers.map(t=>`
      <button type="button" class="training-tier-card ${t.isSpecial?'training-tier-card--special':''}" data-tier="${t.id}">
        <strong>${t.label}</strong>
        <small>${t.range}</small>
        <em>${t.traits.length} rasgos</em>
      </button>
    `).join('');
